...
describe('Chatroom', () => {
    ...
    let chatrooms, chatRoom, userJohn;
    ...
    describe('join', () => {
        it('should create a new room with a new user', () => {
            let userMaria = {id: 'user-maria', name: 'maria'};
            let courseRoom = {name: 'course'};
    ...
    describe('leave', () => {
        it('should remove an user from a room', () => {
            expect(chatrooms.rooms[0].users).to.have.lengthOf(1);

            chatrooms.leave(userJohn.id);

            expect(chatrooms.rooms[0].users).to.have.lengthOf(0);
        });
    });
