...
var isBuf = __webpack_require__(136);
...
var XHR = __webpack_require__(151);
var JSONP = __webpack_require__(150);
var websocket = __webpack_require__(152);
...
var _socket = __webpack_require__(162);

var _socket2 = _interopRequireDefault(_socket);

var _mustache = __webpack_require__(159);
...
var ChatSocket = function () {
    function ChatSocket() {
        ...
        this.messages = (0, _jquery2.default)('#messages');
        this.locationButton = (0, _jquery2.default)('#send-location');
    ...
    _createClass(ChatSocket, [{
        ...
        value: function onNewMessage(message) {
            ...
            var html = _mustache2.default.render(this.messageTemplate, {
                from: message.from,
                text: message.text,
        ...
        key: 'onNewLocatonMessage',
        value: function onNewLocatonMessage(message) {
            var formattedTime = (0, _moment2.default)(message.createdAt).format('h:mm a');

            var html = _mustache2.default.render(this.locationTemplate, {
                from: message.from,
                url: message.url,
                createdAt: formattedTime
            });
        ...
        key: 'onSendLocation',
        value: function onSendLocation() {
            var that = this;

            that.locationButton.attr('disabled', 'disabled').text('Sending location...');

            that.getLocation().then(function (position) {
                return that.emitLocation(position);
            }).catch(function (error) {
                return alert(error);
            }).then(function () {
                return that.locationButton.removeAttr('disabled').text('Send location');
            });
        }
    }, {
        key: 'onUpdateUserList',
        value: function onUpdateUserList(users) {
        ...
        value: function scrollToBottom() {
            var newMessage = this.messages.children('li:last-child');

            var clientHeight = this.messages.prop('clientHeight');
            var scrollTop = this.messages.prop('scrollTop');
...
var _ChatSocket = __webpack_require__(138);

var _ChatSocket2 = _interopRequireDefault(_ChatSocket);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var chat = new _ChatSocket2.default();
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(173);
  } catch (e) { }
}
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(171);
